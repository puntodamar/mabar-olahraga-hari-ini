  ...
  public: {
    Tables: {
      ...
      community_contacts: {
        ...
        Relationships: [
          {
            foreignKeyName: "contacts_community_id_fkey"
          ...
          },
          {
            ...
            columns: ["community_id"]
            isOneToOne: true
            referencedRelation: "community_list_options"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      schedules: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "schedules_place_id_fkey"
            columns: ["venue_id"]
            isOneToOne: false
            referencedRelation: "venue_list"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "schedules_place_id_fkey"
    ...
    Functions: {
      ...
      update_venue: {
        Args: { p_id: number; p_lat?: number; p_lng?: number; p_name?: string }
        Returns: {
          id: number
          location: unknown
          name: string
